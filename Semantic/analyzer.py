...
def Semantic_Analysis(lexical, rule):
    ...
    #    curFunction._.nVars=n
        ...
        CHR_ = t_attrib(CHR, None, CHR(
            char_, lexical.get_Cte(lexical.secondary_Token)))
        StackSem.append(CHR_)

    elif rule == STR_RULE:
        STR_ = t_attrib(STR, None, STR(string_, lexical.get_Cte(
            lexical.secondary_Token), lexical.secondary_Token))
        StackSem.append(STR_)

    elif rule == NUM_RULE:
        NUM_ = t_attrib(NUM, None, NUM(int_, lexical.get_Cte(
            lexical.secondary_Token), lexical.secondary_Token))
        ...
        generated_code.write(
            "BEGIN_FUNC "+str(f._.nIndex)+" "+str(f._.nParams)+"\n")
        ...
        StackSem.append(F_)
        generated_code.write("\tDE_REF "+str(n)+"\n")
        ...
        StackSem.append(MT_)
        generated_code.write("\tTJMP_FW L"+str(rLabel)+"\n")
        ...
        MW_._.label = rLabel
        StackSem.append(MW_)
        generated_code.write("L"+str(rLabel)+"\n")
